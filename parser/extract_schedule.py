                    ...
                    "properties": {
                        ...
                        "product_name": {
                            ...
                            "description": (
                                ...
                                "형식을 갖춰야 한다. 대표품목명은 사용자가 검색창에 실제로 입력할 "
                                "일반명사(카시트, 유모차, 하이체어, 기저귀, 이유식, 놀이매트 등)이며 "
                                "브랜드명이나 모델명만으로는 대체될 수 없다 - 원문에 명시가 없어도 "
...
하이체어, 기저귀, 이유식, 놀이매트 등)로, 브랜드명/모델명만 있고 대표품목명이
빠지면 유저가 그 품목으로 검색해도 이 공구가 검색 결과에서 완전히 누락된다.
